...
class ButtonInfo:
    def get_info(self, dgcog, monster_model):
        ...
        result.main_damage = self._calculate_coop_damage(dgcog, monster_model, max_level)
        ...
        if slb_level is None:
            ...
            result.main_slb_damage = self._calculate_coop_damage(dgcog, monster_model, slb_level)
        ...
        result.main_solo_damage = self._calculate_solo_damage(dgcog, monster_model, max_level)
        ...
        if slb_level is None:
            ...
            result.main_solo_slb_damage = self._calculate_solo_damage(dgcog, monster_model, slb_level)
    ...
    def _calculate_coop_damage(self, dgcog, monster_model, level, num_atkplus_latent=0, num_atkplus2_latent=0):
        return self._calculate_damage(dgcog, monster_model, level, True, num_atkplus_latent, num_atkplus2_latent)

    def _calculate_solo_damage(self, dgcog, monster_model, level, num_atkplus_latent=0, num_atkplus2_latent=0):
        return self._calculate_damage(dgcog, monster_model, level, False, num_atkplus_latent, num_atkplus2_latent)

    def _calculate_damage(self, dgcog, monster_model, level, multiplayer, num_atkplus_latent=0, num_atkplus2_latent=0):
