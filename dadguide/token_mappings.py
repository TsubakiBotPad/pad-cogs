...
AWOKEN_PREFIX_MAP = {
    ...
    Awakenings.DEVILKILLER: ('vk', 'dek'),
    Awakenings.MACHINEKILLER: ('mk', 'mak'),
    Awakenings.BALANCEDKILLER: ('bk', 'bak'),
    Awakenings.ATTACKERKILLER: ('ak', 'aak'),
    Awakenings.PHYSICALKILLER: ('pk', 'phk'),
    Awakenings.HEALERKILLER: ('hk', 'hek'),
    Awakenings.EVOMATKILLER: ('evok',),
    Awakenings.AWOKENKILLER: ('awok',),
    Awakenings.FODDERKILLER: ('enhk',),
    Awakenings.REDEEMKILLER: ('vendork',),
    ...
    Awakenings.JAMMERBLESSING: ('jblessing',),
    Awakenings.POISONBLESSING: ('pblessing',),
