...
AWOKEN_SKILL_MAP = {
    ...
    AwokenSkills.SUBATTRRED: ('subattrr', '?r+'),
    AwokenSkills.SUBATTRBLUE: ('subattrb', '?b+'),
    AwokenSkills.SUBATTRGREEN: ('subattrg', '?g+'),
    AwokenSkills.SUBATTRLIGHT: ('subattrl', '?l+'),
    AwokenSkills.SUBATTRDARK: ('subattrd', '?d+'),
    AwokenSkills.TPAPLUS: ('tpa+', 'pronged+'),
    AwokenSkills.SKILLCHARGEPLUS: ('rainbowhaste+', 'skillcharge+', 'hasteawo+'),
    AwokenSkills.AUTOHEALPLUS: ('autoheal+',),
    AwokenSkills.ENHANCEDREDPLUS: ('oer+', 'oe+'),
    AwokenSkills.ENHANCEDBLUEPLUS: ('oeb+', 'oe+'),
    AwokenSkills.ENHANCEDGREENPLUS: ('oeg+', 'oe+'),
    AwokenSkills.ENHANCEDLIGHTPLUS: ('oel+', 'oe+'),
    AwokenSkills.ENHANCEDDARKPLUS: ('oed+', 'oe+'),
    AwokenSkills.ENHANCEDHEALPLUS: ('htpa+', 'oeh+'),
}
